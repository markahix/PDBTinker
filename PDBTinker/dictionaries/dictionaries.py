...
# amino_acid_list = np.load("amino_acid_list.npy")
# nucleic_acid_list = np.load("nucleic_acid_list.npy")
# water_list = np.load("water_list.npy")
# ion_list = np.load("ion_list.npy")
# non_standard_list = np.load("non_standard_list.npy")
# cap_list = np.load("cap_list.npy")
